  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <label className="text-white text-sm font-semibold mb-2" htmlFor="description">
          Transaction Description
        </label>
        <input
      ...
      {/* Amount */}
      <div className="flex flex-col">
        <label className="text-white text-sm font-semibold mb-2" htmlFor="amount">
          Amount ($)
        </label>
        <input
          className="px-4 py-3 text-black rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-md transition-all ease-in-out duration-300"
      ...
      {/* Location */}
      <div className="flex flex-col">
        <label className="text-white text-sm font-semibold mb-2" htmlFor="location">
          Location
        </label>
        <input
          className="px-4 py-3 text-black rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-md transition-all ease-in-out duration-300"
